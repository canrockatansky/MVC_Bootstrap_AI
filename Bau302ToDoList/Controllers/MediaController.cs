...
namespace Bau302ToDoList.Controllers
{
    ...
    public class MediaController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "ID,Name,Description,Extention,FilePath,FileSize,Year,Month,ContentType,CreateDate,CreatedBy,UpdateDate,UpdatedBy")] Media media)
        {
            if (ModelState.IsValid)
            {
                ...
                if(!String.IsNullOrEmpty(media.FilePath))
                {
                    ...
                    media.Extention = fileinfo.Extension;
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "ID,Name,Description,Extention,FilePath,FileSize,Year,Month,ContentType,CreateDate,CreatedBy,UpdateDate,UpdatedBy")] Media media)
        {
            if (ModelState.IsValid)
            {
                media.UpdateDate = DateTime.Now;
